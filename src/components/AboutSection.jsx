...
const values = [
  ...
  {
    id: "PORTOFINO / FACTORY",
    title: "Власне виробництво у Львові",
    desc: "Наше серце — завод PortoFino у Львові. Це сучасний виробничий комплекс, де поєднуються італійські технології та українська майстерність для створення ідеальних дверей прихованого монтажу."
  },
  {
    id: "02 / VALUES",
